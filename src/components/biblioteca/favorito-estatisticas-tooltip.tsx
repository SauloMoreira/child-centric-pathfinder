...
// mouse no ícone de favoritar de um Atendimento ou Cota: total de acessos,
// inserções em painéis e itens criados a partir deste(a) como referência.
      ...
      <TooltipContent side="top" className="text-[11px] leading-relaxed">
        {stats.isLoading ? (
          ...
          <div className="space-y-0.5">
            <p>{stats.data?.access_count ?? 0} acessos</p>
