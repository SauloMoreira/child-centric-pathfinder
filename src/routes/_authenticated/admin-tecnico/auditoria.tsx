  ...
  component: () => (
    ...
    >
      <div className="surface-panel p-6 text-sm text-muted-foreground">
        Consulta consolidada será liberada com a Fase 2 (visão paginada por entidade, ator, órgão,
        resultado e correlation ID). Os eventos já são registrados em{" "}
        <code className="font-mono">private.audit_events</code> e podem ser inspecionados pelo
        operador autorizado via banco.
      </div>
    </TecnicoPage>
  ),
});
