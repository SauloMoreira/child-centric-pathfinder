...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      access_request_status: "pendente" | "em_analise" | "aprovada" | "rejeitada" | "cancelada";
      app_role: "admin_tecnico" | "admin_institucional" | "defensor_publico" | "membro_equipe";
...
export const Constants = {
  public: {
    Enums: {
      ...
      content_visibility: ["privado", "orgao", "institucional"],
      member_defensor_bond_status: ["ativo", "encerrado"],
      profile_status: ["aguardando_dados", "aguardando_aprovacao", "ativo", "suspenso", "inativo"],
      team_invitation_status: [
        "preparando",
        "enviado",
        "aceito",
